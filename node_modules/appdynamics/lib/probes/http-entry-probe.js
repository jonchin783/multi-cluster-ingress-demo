...
HttpEntryProbe.prototype.finalizeTransaction = function (err, profiler, time, transaction, req, res) {
  ...
  if (transaction.error) {
    if (transaction.error instanceof Error) {
      transaction.error = {
        name: "JS " + transaction.error.name,
    ...
    if (statusCodeConfig) {
      ...
      // TODO: remove this code once libagent gets upgraded to support default/override strings for HTTP errors
      var error, errorMsg, statusCode = transaction.statusCode;
      ...
      transaction.error = { message: errorMsg, name: error };
    }
  }
