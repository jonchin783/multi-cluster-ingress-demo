...
Proxy.prototype.release = function(proxied) {
...
Proxy.prototype.before = function(obj, meths, hook, isCallbackHook, copyAllProps, methsInvocationCtxt) {
  var self = this;
...
Proxy.prototype.after = function(obj, meths, hook, copyAllProps, methsInvocationCtxt) {
  var self = this;
...
Proxy.prototype.isPromiseSupported = function() {
...
Proxy.prototype.promise = function(returnVal, promiseHook, obj, methodArgs, locals) {
...
Proxy.prototype.around = function(obj, meths, hookBefore, hookAfter, copyAllProps, methsInvocationCtxt) {
  var self = this;
...
Proxy.prototype.callback = function(args, pos, hookBefore, hookAfter, methsInvocationCtxt) {
  var self = this;
...
/*eslint-disable */
Proxy.prototype.getArityFunction = function(arity, functionLogic) {
  var returnFunc;
  switch(arity) {
    case 0:
      returnFunc = function () {
